...
##IP of zookeeper##
sudo sed -i 's/# storm.zookeeper.servers:.*/storm.zookeeper.servers:\n       - "'$1'"\n       - "'$2'"\n       - "'$3'"/' /home/storm/apache-storm-1.0.6/conf/storm.yaml

##IP of Nimbus##
sudo sed -i 's/# nimbus.seeds:.*/nimbus.seeds: ["'$1'"]/' /home/storm/apache-storm-1.0.6/conf/storm.yaml
...
sudo -s <<EOF
mv /etc/systemd/system/nimbus.service /etc/systemd/system/bkp3_nimbus.service
...
User=storm
Group=storm
WorkingDirectory=/home/storm/apache-storm-1.0.6/
ExecStart=/home/storm/apache-storm-1.0.6/bin/storm nimbus
Restart=on-failure
RestartSec=10
...
sudo -s <<EOF
mv /etc/systemd/system/storm-ui.service /etc/systemd/system/bkp3_storm-ui.service
...
Type=simple
User=storm
ExecStart=/home/storm/apache-storm-1.0.6/bin/storm ui
Restart=on-abort
...
Type=simple
User=storm
ExecStart=/home/storm/apache-storm-1.0.6/bin/storm supervisor
Restart=on-abort
